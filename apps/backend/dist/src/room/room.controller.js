...
let RoomController = class RoomController {
    ...
    getAvailableRooms(query) {
        return this.roomService.getAvailableRooms(new Date(query.checkIn), new Date(query.checkOut));
    }
    findOne(id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], RoomController.prototype, "getStats", null);
__decorate([
    (0, common_1.Get)('available'),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [room_dto_1.GetAvailableRoomsDto]),
    __metadata("design:returntype", void 0)
